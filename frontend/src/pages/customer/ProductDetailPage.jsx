...
import { FiShoppingCart, FiArrowLeft, FiPlus, FiMinus, FiStar } from 'react-icons/fi';
    ...
    <div className="space-y-4">
      ...
      <div className="flex items-center gap-4 bg-gray-50 rounded-xl p-4">
        <div className="text-center">
          ...
          <p className="text-xs text-gray-400 mt-1">{reviews.length} review(s)</p>
        </div>
        ...
        <div key={review._id}
          ...
          <div className="flex items-start justify-between mb-2">
            <div className="flex items-center gap-2">
              <div className="bg-primary text-white w-8 h-8 rounded-full
    ...
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100
        ...
        <div className="grid grid-cols-1 md:grid-cols-2">
          ...
          {/* Image */}
          <div className="bg-gray-50 h-72 md:h-auto flex items-center
          ...
          <div className="p-6 flex flex-col justify-between">
            <div>
              <span className="text-xs text-primary font-medium bg-green-50
        ...
        {user && !canReview && reviews.length > 0 && (
          <div className="bg-blue-50 rounded-xl p-3 text-center">
            <p className="text-blue-600 text-xs">
              {reviews.find(r => r.customerId?._id === user?._id || r.customerId === user?._id)
